...
sudo pacman -S lxterminal --noconfirm --needed #终端
sudo pacman -S nemo nemo-fileroller cinnamon-translations --noconfirm --needed #文件管理器
sudo pacman -S nemo-terminal nemo-preview --noconfirm --needed # nemo插件
